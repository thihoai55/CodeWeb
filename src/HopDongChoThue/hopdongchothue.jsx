...
function HopDongChoThue() {
  ...
  const SubTitle = ({ children }) => (
    <div style={{ fontWeight: 700, margin: '10px 0 6px', color: '#111' }}>{children}</div>
  );

  const LineField = ({ label, flex = 1 }) => (
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
      <div style={{ minWidth: '120px' }}>{label}</div>
      <div style={{ flex, borderBottom: '1px dotted #9e9e9e', height: 0 }} />
    </div>
  );
      ...
      <div style={{ display: 'flex', flex: 1 }}>
        ...
        <div style={{ flex: 1, padding: '20px 0 0 0' }}>
          ...
          <div style={{ background: '#fff', borderRadius: '10px', padding: '24px 28px', margin: '0 40px 24px 100px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            ...
            <div style={{ textAlign: 'center', color: '#555' }}>Độc lập - Tự do - Hạnh phúc</div>
            <div style={{ textAlign: 'center', color: '#999', margin: '4px 0 10px' }}>------**------</div>
            ...
            <div style={{ marginTop: '12px', color: '#333' }}>Hai bên cùng thỏa thuận và đồng ý với nội dung sau:</div>

            {/* Điều 1 */}
            <ClauseTitle>Điều 1:</ClauseTitle>
            <div style={{ color: '#333', marginBottom: '8px' }}>
              Bên A đồng ý cho bên B thuê một phòng thuộc nhà số <span style={{ borderBottom: '1px dotted #9e9e9e' }}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            </div>
            <div style={{ color: '#333' }}>
              Thời hạn thuê nhà là <span style={{ borderBottom: '1px dotted #9e9e9e' }}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> tháng kể từ ngày <span style={{ borderBottom: '1px dotted #9e9e9e' }}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> tháng <span style={{ borderBottom: '1px dotted #9e9e9e' }}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> năm <span style={{ borderBottom: '1px dotted #9e9e9e' }}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            </div>

            {/* Điều 2 */}
            <ClauseTitle>Điều 2:</ClauseTitle>
            <div style={{ color: '#333', marginBottom: '8px' }}>
              Giá tiền thuê nhà là <span style={{ borderBottom: '1px dotted #9e9e9e' }}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> đồng/tháng (Bằng chữ: <span style={{ borderBottom: '1px dotted #9e9e9e' }}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> ).
            </div>
            <div style={{ color: '#333', marginBottom: '8px' }}>
              Tiền thuê nhà Bên B thanh toán cho Bên A từ ngày ..... Tấy hàng tháng.
            </div>
            <div style={{ color: '#333', marginBottom: '8px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              <CheckboxItem id={'a1'}>Yêu cầu Bên thuê sử dụng nhà ở đúng mục đích và đúng nội quy sử dụng nhà trọ  kèm hợp đồng thuê nhà trọ này; phối hợp với các đơn vị liên quan trong việc xử lý vi phạm quy định và quản lý sử dụng nhà trọ;</CheckboxItem>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '10px' }}>
              <CheckboxItem id={'a3'}>Giao nhà ở cho Bên thuê đúng thời gian quy định tại Điều 1 của hợp đồng này;</CheckboxItem>
              <CheckboxItem id={'a4'}>Xây dựng nội quy sử dụng nhà ở sinh viên và phổ biến quy định về sử dụng nhà ở sinh viên cho Bên thuê và các tổ chức, cá nhân liên quan biết;</CheckboxItem>
              <CheckboxItem id={'a5'}>Thực hiện quản lý vận hành, bảo trì nhà ở cho thuê theo quy định;</CheckboxItem>
              <CheckboxItem id={'a6'}>Thông báo cho Bên thuê những thay đổi về giá thuê ít nhất 01 tháng trước khi áp dụng giá mới.</CheckboxItem>
              <CheckboxItem id={'a7'}>Phối hợp với Ban tự quản nhà sinh viên tuyên truyền, đôn đốc sinh viên thuê nhà ở chấp hành nội quy quản lý sử dụng nhà ở sinh viên.</CheckboxItem>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <span>• Các nghĩa vụ khác theo thỏa thuận</span>
                <div style={{ flex: 1, borderBottom: '1px dotted #9e9e9e', height: 0 }} />
              </div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '12px' }}>
              ...
              <CheckboxItem id={'b7'}>Không được tự ý sửa chữa, cải tạo nhà ở thuê; chấp hành đầy đủ những quy định về quản lý sử dụng nhà ở và các quy định của cơ quan có thẩm quyền về quản lý nhà ở;</CheckboxItem>
              <CheckboxItem id={'b8'}>Chấp hành các quy định về nghiêm cấm các hành vi sử dụng nhà ở và giữ gìn vệ sinh môi trường và an ninh trật tự trong khu ở;</CheckboxItem>
              <CheckboxItem id={'b9'}>Giao lại nhà cho Bên cho thuê trong các trường hợp chấm dứt hợp đồng quy định tại Điều 7 của hợp đồng này; các trang thiết bị trong nhà ở thuộc diện trang bị phải hoàn trả.</CheckboxItem>
            </div>
            ...
            <div style={{ marginTop: '6px', color: '#333' }}>Khoản khác:</div>
            <div style={{ marginTop: '6px' }}>
              <div style={{ borderBottom: '1px dotted #9e9e9e', height: 0, marginBottom: '10px' }} />
              <div style={{ borderBottom: '1px dotted #9e9e9e', height: 0, marginBottom: '10px' }} />
              <div style={{ borderBottom: '1px dotted #9e9e9e', height: 0, marginBottom: '10px' }} />
            </div>
            <div style={{ textAlign: 'right', color: '#333', margin: '6px 0 10px' }}>......, ngày...tháng...năm....</div>
            ...
            <div style={{ textAlign: 'right', marginTop: '16px' }}>
              <button style={{ padding: '10px 16px', background: '#1976d2', color: '#fff', border: 'none', borderRadius: '6px', fontWeight: 600, cursor: 'pointer' }} onClick={() => alert('Đã lưu lựa chọn điều khoản (demo).')}>
